...
import static com.ibm.domino.services.solrbak.SolrJUtil.*;

public class TestSolrJUtil {
	@Test
	public void test_1_Update(){
		...
		// TODO to handle err
		Object client = getSolrUpdateClient(zkHosts);
		System.out.println("client=" + client);
		Object req = createUpdateRequest();
		...
		System.out.println(postUpdateToSolrWithRetries(client, req, collection, retry));
	}
